    ...
    return (
      <div className="listingSection__wrap">
        ...
        <div className="text-neutral-6000 dark:text-neutral-300">
          <p>
            Explore our diverse selection of rental cars, from compact models perfect for
            city excursions to spacious SUVs ideal for family adventures. Each vehicle
            is meticulously maintained to ensure a safe and comfortable journey, offering
            reliability and performance on every road. Find the perfect ride to complement
            your travel plans and drive with confidence.
          </p>
        </div>
      </div>
    );
